...
@Component({
  selector: 'app-practice-slides-carousel',
  templateUrl: './practice-slides-carousel.component.html',
  styleUrls: ['./practice-slides-carousel.component.scss'],
})
export class PracticeSlidesCarouselComponent implements OnInit {
  @Input() public practiceId: string;
  ...
  addSlideMutation = this.slideService.addSlideForPractice();
  updateSlideMutation = this.slideService.updateSlideForPractice();
  chageSlideOrderMutation = this.slideService.changeSlideOrderForPractice();

  public slides$: IPracticeSlide[] = [];
  public currentIndex = 0;
  public currentSlide?: IPracticeSlide;
  ...
  updateSlides(newSlides: IPracticeSlide[]) {
  ...
  onAddNewSlide() {
    ...
    this.addSlideMutation.mutate({ slide: slide, practiceId: this.practiceId });
  }

  onChangeSlide(slide: IPracticeSlide) {
    this.updateSlideMutation
      .mutate({ practiceId: this.practiceId, slide: slide })
      .finally(() => {
